...
Body::Body(const Napi::CallbackInfo &info) : Common(info.This(), "Body") {
	NAPI_ENV;
	super(info);
...
JS_IMPLEMENT_GETTER(Body, type) {
	THIS_CHECK;
	RET_STR(_cacheType.c_str());
}

JS_IMPLEMENT_SETTER(Body, type) {
	THIS_CHECK;
	SETTER_STR_ARG;
...
JS_IMPLEMENT_GETTER(Body, quat) {
	THIS_CHECK;
	QUAT_TO_OBJ(_cacheRot, quat);
	RET_VALUE(quat);
}

JS_IMPLEMENT_SETTER(Body, quat) {
	THIS_CHECK;
	SETTER_QUAT_ARG;
...
JS_IMPLEMENT_SETTER(Body, factl) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Body, facta) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_GETTER(Body, map) {
	THIS_CHECK;
	Napi::Value obj = JS_OBJECT;
...
JS_IMPLEMENT_SETTER(Body, dampl) {
	THIS_CHECK;
	SETTER_FLOAT_ARG;
...
JS_IMPLEMENT_SETTER(Body, dampa) {
	THIS_CHECK;
	SETTER_FLOAT_ARG;
...
JS_IMPLEMENT_SETTER(Body, frict) {
	THIS_CHECK;
	SETTER_FLOAT_ARG;
...
JS_IMPLEMENT_SETTER(Body, sleepy) {
	THIS_CHECK;
	SETTER_BOOL_ARG;
...
JS_IMPLEMENT_GETTER(Body, sleepy) {
	THIS_CHECK;
...
JS_IMPLEMENT_METHOD(Body, destroy) {
	THIS_CHECK;
	emit("destroy");
	_destroy();
	RET_UNDEFINED;
...
JS_IMPLEMENT_GETTER(Body, isDestroyed) {
	THIS_CHECK;
