...
Joint::Joint(const Napi::CallbackInfo &info) : Common(info.This(), "Joint") { // NAPI_ENV;
	super(info);
...
JS_IMPLEMENT_SETTER(Joint, broken) {
	THIS_CHECK;
	SETTER_BOOL_ARG;
...
JS_IMPLEMENT_GETTER(Joint, broken) {
	THIS_CHECK;
	RET_BOOL(_cacheBroken);
}

JS_IMPLEMENT_SETTER(Joint, maximp) {
	THIS_CHECK;
	SETTER_FLOAT_ARG;
...
JS_IMPLEMENT_GETTER(Joint, maximp) {
	THIS_CHECK;
	RET_NUM(_cacheMaximp);
}

JS_IMPLEMENT_SETTER(Joint, posa) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, posb) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, rota) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, rotb) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, minl) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, maxl) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, mina) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, maxa) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, dampl) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, dampa) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, stifl) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, stifa) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, springl) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, springa) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, motorl) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, motora) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, motorlf) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, motoraf) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, motorlv) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
JS_IMPLEMENT_SETTER(Joint, motorav) {
	THIS_CHECK;
	SETTER_VEC3_ARG;
...
void Joint::_rebuild() {
	...
	_constraint = new (btAlignedAlloc(sizeof(btGeneric6DofSpringConstraint), 16))
	    btGeneric6DofSpringConstraint(*rb1, *rb2, transformA, transformB, true);
...
JS_IMPLEMENT_METHOD(Joint, destroy) {
	THIS_CHECK;
	emit("destroy");
	_destroy();
	RET_UNDEFINED;
...
JS_IMPLEMENT_GETTER(Joint, isDestroyed) {
	THIS_CHECK;
